...
players |>
  mutate(trueshooting = (PTS/(2*(FGA + (.44*FTA))))*100) |>
  arrange(desc(trueshooting)) |>
  filter(MP > 100, FGA >= 219)
```

**ANSWER** Who do you get as the first result, and what was his trueshooting percentage? Moss Bol, is trueshooting was 0.78 but he didn't take as many shots has someone who starts. I added FGA. In my opinion, I like that better because you can see who takes a lot more shots and make a better conclusion or debate it a little more.  
