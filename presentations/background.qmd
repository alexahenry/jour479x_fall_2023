...
```
It appears here that R may not like the seperate function. I have over 1,600 results due to R duplicating entries. So I'll take the seperate out and see if that's better considering I'm only looking at state. 
